...
The current generic SCAR regression suite has 142 passing tests. The separate
...
user-function boundary; the new regression is covered by the 142-test suite.
